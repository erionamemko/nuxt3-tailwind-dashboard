  ...
  <div class="py-3 px-4">
    <div class="relative max-w-xs">
      ...
      <input
        ...
        class="py-2 pr-4 px-3 ps-9 block w-full shadow-sm rounded-lg text-md focus:z-10 disabled:opacity-50 disabled:pointer-events-none border-b-[gray] border-b border-solid"
      />
       <Icon
        v-if="searchQuery"
            @click="clearSearch"
